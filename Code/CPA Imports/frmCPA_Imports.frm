...
Begin VB.Form frmCPA_Imports 
   ...
   Begin VB.CommandButton cmdSearch 
      Height          =   325
      Left            =   8260
      Picture         =   "frmCPA_Imports.frx":0CCE
      Style           =   1  'Graphical
      TabIndex        =   31
      Top             =   1100
      Width           =   375
   ...
   Begin VB.CommandButton cmdDelete 
      DisabledPicture =   "frmCPA_Imports.frx":1200
      Enabled         =   0   'False
      Height          =   300
      Left            =   3240
      MaskColor       =   &H8000000F&
      Picture         =   "frmCPA_Imports.frx":28D2
      Style           =   1  'Graphical
      TabIndex        =   29
   ...
   Begin VB.CommandButton cmdInsert 
      DisabledPicture =   "frmCPA_Imports.frx":3FA4
      Enabled         =   0   'False
      Height          =   300
      Left            =   1680
      MaskColor       =   &H8000000F&
      Picture         =   "frmCPA_Imports.frx":5676
      Style           =   1  'Graphical
      TabIndex        =   28
      ToolTipText     =   "Clear All"
      Top             =   8710
   ...
   Begin VB.CommandButton cmdReplace 
      DisabledPicture =   "frmCPA_Imports.frx":6D48
      Enabled         =   0   'False
      Height          =   300
      Left            =   125
      MaskColor       =   &H8000000F&
      Picture         =   "frmCPA_Imports.frx":841A
      Style           =   1  'Graphical
      TabIndex        =   27
      ToolTipText     =   "Clear All"
      Top             =   8710
   ...
   Begin VB.CommandButton cmdReset 
      DisabledPicture =   "frmCPA_Imports.frx":9AEC
      Height          =   300
      Left            =   6375
      MaskColor       =   &H8000000F&
      Picture         =   "frmCPA_Imports.frx":B1BE
      Style           =   1  'Graphical
      TabIndex        =   26
      ToolTipText     =   "Clear All"
      Top             =   8710
   ...
   Begin VB.CommandButton cmdClose 
      Cancel          =   -1  'True
      DisabledPicture =   "frmCPA_Imports.frx":C890
      Height          =   300
      Left            =   7930
      MaskColor       =   &H8000000F&
      Picture         =   "frmCPA_Imports.frx":DF62
      Style           =   1  'Graphical
      TabIndex        =   25
      ToolTipText     =   "Exit"
      Top             =   8710
   ...
   Begin VB.CommandButton cmdLayoutMaint 
      DisabledPicture =   "frmCPA_Imports.frx":F634
      Height          =   300
      Left            =   4820
      MaskColor       =   &H8000000F&
      Picture         =   "frmCPA_Imports.frx":10D06
      Style           =   1  'Graphical
      TabIndex        =   24
      Top             =   8710
      Width           =   1550
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   735
      Left            =   100
      Picture         =   "frmCPA_Imports.frx":123D8
      ScaleHeight     =   735
      ScaleWidth      =   9405
      TabIndex        =   17
      TabStop         =   0   'False
   ...
   Begin VB.CommandButton cmdPrevious 
      ...
      Left            =   9000
      MaskColor       =   &H00000000&
      Picture         =   "frmCPA_Imports.frx":28B2E
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   Begin VB.CommandButton cmdNext 
      ...
      Left            =   9000
      MaskColor       =   &H00000000&
      Picture         =   "frmCPA_Imports.frx":2A380
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.ListBox lstLayout 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   4830
      ItemData        =   "frmCPA_Imports.frx":2BA6A
      Left            =   100
      List            =   "frmCPA_Imports.frx":2BA71
      Sorted          =   -1  'True
      Style           =   1  'Checkbox
      TabIndex        =   8
   ...
   Begin VB.ComboBox cboDelimeter 
      ...
      ForeColor       =   &H00000000&
      Height          =   345
      ItemData        =   "frmCPA_Imports.frx":2BA80
      Left            =   8760
      List            =   "frmCPA_Imports.frx":2BA82
      TabIndex        =   2
   ...
   Begin VB.ComboBox cboImportType 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmCPA_Imports.frx":2BA84
      Left            =   120
      List            =   "frmCPA_Imports.frx":2BA86
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmCPA_Imports"
...
'//
'// Funtionality:
'// -- Beta Design phase development & testing based on the following import layouts:
'//    -- AR Posted Invoice
'//    -- AR Pending Invoice
'//    -- AP Posted Vouchers
'//    -- AP Pending Vouchers
...
Private Sub cmdExit_Click()
  ...
  '//****
    ...
    Unload frmCPA_Imports

    '//****
    Set frmCPA_Imports = Nothing
...
Private Sub Form_Load()
  ...
  '//**************************************************************************
  '// Form_Load - prepares frmCPA_Imports by initializing form objects and controls...
  '//
  '// Created:  12/26/2001 John C. Kirwin (JCK)
  '// Modified: 03/03/2002 JCK - Formated & Commented
  '//
  ...
  '//**************************************************************************
    ...
    CPAErrorHandler.ErrorHandler "frmCPA_Imports", _
